...
TwoDirection.obj: ../TwoDirection.c $(GEN_OPTS) $(GEN_SRCS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"C:/ti/ccsv5/tools/compiler/c2000_6.1.0/bin/cl2000" -v28 -ml -mt --float_support=fpu32 -g --include_path="C:/ti/00IC ZQ28335/DSP2833x_common/include" --include_path="C:/ti/00IC ZQ28335/DSP2833x_headers/include" --define="LARGE_MODEL" --define="_DEBUG" --diag_warning=225 --display_error_number --preproc_with_compile --preproc_dependency="TwoDirection.pp" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: $<'
	@echo ' '
